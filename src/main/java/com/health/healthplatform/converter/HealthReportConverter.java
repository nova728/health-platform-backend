...
public class HealthReportConverter {
    ...
    public static HealthReportDTO toDTO(HealthReport entity) {
        ...
        HealthReportDTO dto = HealthReportDTO.builder()
                ...
                .height(entity.getHeight())                .systolic(entity.getSystolic() != null ? entity.getSystolic().doubleValue() : null)
                .diastolic(entity.getDiastolic() != null ? entity.getDiastolic().doubleValue() : null)
                .bloodPressureStatus(entity.getBloodPressureStatus())
                .heartRate(entity.getHeartRate() != null ? entity.getHeartRate().doubleValue() : null)
